...
from XMUSIC.core.dir import COUPLE_DIR
from XMUSIC.mongo.couples_db import get_couple, save_couple


ASSETS = Path("XMUSIC/assets")
...
async def generate_image(chat_id: int, uid1: int, uid2: int, date: str) -> str:
    base = Image.open(ASSETS / "xmusic/couple.png").convert("RGBA")
